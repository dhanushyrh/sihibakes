...
import {
  OrdersHubProductMarquee,
  OrdersHubReviewMarquee,
} from "@/components/orders/OrdersHubMarquees";
import {
  formatDisplayPhone,
  instagramHref,
  telHref,
    ...
    <main className="mx-auto flex min-h-[calc(100svh-5rem)] w-full max-w-lg flex-col px-4 py-6 pb-[env(safe-area-inset-bottom)]">
      <div className="text-center">
        <Image
          ...
          sizes="144px"
        />
        <OrdersHubProductMarquee products={products} />
      ...
      <OrdersHubReviewMarquee reviews={reviews} />
